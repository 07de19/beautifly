...
$(document).ready(function() { 
	...
	var countNum = new_curr_url.searchParams.get("countNum");

	//console.log(countNum);

	$("#i_result").html(countNum);


	// 상품 총 가격 스크립트
	var productPrice = $("#productPrice").val();
	var pSum = productPrice * countNum;
...
<div class="container">
		...
		<h2 class="mt-4 mb-3" style="font-weight: bold;">주문 페이지</h2>
			...
			<form name="orderFrm" action="${pageContext.request.contextPath}/pay/insertPay.do" method="post" style="margin-left:40px; width:1000px;">
				...
				<table style="margin-left: 20px; width:920px; text-align:center; border:1px solid;">
					...
					<tr>
						<td style="">
							<input type="hidden" id="productName" class="productName" value="${product.productName}" />
							${product.productName}
						</td>
						<td>
							<span class="i_result" id="i_result"></span>
						</td>
						<td>	
							<input type="hidden" name="productPrice" id="productPrice" class="productPrice" value="${product.productPrice}" />
							<span class="i_result2" id="i_result2"></span>
						</td>
					</tr> 
				</table>
				<br /><br /><br /><br />
				...
				<table style="margin-left: 20px;">
					<tr>
						...
						<td style="width:300px;">
							<span class="i_result2" id="i_result2"></span> 원
						</td>
					</tr>
					<tr>
						<th>배송비 : </th>
						<td>
							<span class="i_result3" id="i_result3"></span> 원
						</td>
					</tr>
					<tr>
						<th><a style="font-size:20px;">총 결제 금액 : </a></th>
						<td>	
							<a style="font-size:20px; color:red;"><span class="i_result4" id="i_result4"></span> 원</a>
						</td>
					</tr>
				</table>
	...
	//url 내 type이라는 파라미터의 값을 param에 넣어줌 
	var productNo = new_curr_url.searchParams.get("productNo");
	var countNum = new_curr_url.searchParams.get("countNum");
