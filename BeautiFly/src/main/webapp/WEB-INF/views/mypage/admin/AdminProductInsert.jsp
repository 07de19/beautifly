...
<c:import url="../../common/menubar.jsp"/>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb" style="background-color : #FFF;">
      ...
      <li class="breadcrumb-item active" style="color:#DCB15D;">상품 추가</li>
    </ol>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        <div class="list-group">
          ...
          <a href="${pageContext.request.contextPath}/product/AdminProductInsert.do" class="list-group-item" style="color:#DCB15D;">&nbsp;&nbsp;상품 추가</a>
	     ...
	     <div class="col-lg-9 mb-4">
	       <h2>상품 추가</h2>
	        <div class="Insert-container">
				<form name="ProductInsertFrm" action="${pageContext.request.contextPath}/product/productInsertEnd.do" enctype="multipart/form-data" method="post" >
					<div class="insert-form">
						<table style="border-collapse: separate; border-spacing: 0 15px;">
							...
							<tr>
								...
								<td>
									<div id="product-container">
										<input type="text" class="form-control" name="productName" id="productName_" required>
					            	</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div id="product-container">
										<input type="text" class="form-control" name="companyName" id="companyName_" required>
					            	</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div id="product-container-dropdown">
										<select class="form-control" name="productType" id="productType_">
							...
							<tr>
								...
								<td>
									<div id="product-container-num">
										<input type="number" class="form-control" name="productPrice" id="productPrice_" required>
										<a class="won">원</a>
					            	</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div id="product-container-num">
										<input type="number" class="form-control" name="productPoint" id="productPoint_" required>
										<a class="won">원</a>
					            	</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div id="product-container-dropdown">
										<select class="form-control" name="originCountry" id="originCountry_">
							...
							<tr>
								...
								<td>
									<div id="product-container-num">
										<input type="number" class="form-control" name="productWeight" id="productWeight_" required>
										<a class="won">g</a>
					            	</div>
								</td>
							</tr>
								...
								<td>
									<div id="product-container-image">
									  <div class="custom-file">
									    ...
									    <label class="custom-file-label" for="upFile1">파일 첨부</label>
									  </div>
									</div>
								</td>
							</tr>
								...
								<td>
									<div id="product-container-image">
									  <div class="custom-file">
									    ...
									    <label class="custom-file-label" for="upFile2">파일 첨부</label>
									  </div>
									</div>
								</td>
							</tr>
