...
<c:import url="../../common/menubar.jsp"/>
  ...
  <h2 class="mt-4 mb-3" style="font-weight: bold;">마이 뷰티</h2>
    ...
    <ol class="breadcrumb" style="background-color : #FFF;">
      ...
      <li class="breadcrumb-item active" style="color:black;">관리자 페이지</li>
      <li class="breadcrumb-item active" style="color:black;">결제 및 배송 관리</li>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        <div class="list-group">
          ...
          <a href="${pageContext.request.contextPath}/order/AdminOrderList.do" class="list-group-item" style="border-bottom:1px solid #CFCFCF; color:#DCB15D;">&nbsp;&nbsp;정보 조회</a>
        </div>
      </div>
