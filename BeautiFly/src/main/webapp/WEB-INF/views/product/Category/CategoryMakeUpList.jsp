...
<c:import url="../../common/menubar.jsp"/>
  ...
  <div class="container">
	...
	<ol class="breadcrumb" style="background-color : #FFF; padding:0px; margin-top:10px;">
      ...
      <li class="breadcrumb-item active" style="color:#DCB15D;">메이크업</li>
    </ol>
    
    <h2 class="mt-4 mb-3">메이크업</h2>
    <script>
			$('.carousel').carousel({
				interval : 1000
			})
		...
		<div id="demo" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				...
				<div class="carousel-item active">
    				<img class="d-block w-100" src="${pageContext.request.contextPath }/resources/images/makeup_1.jpg" alt="1 slide">
				...
				<div class="carousel-item">
					<img class="d-block w-100"
						 src="${pageContext.request.contextPath }/resources/images/makeup_2.jpg" alt="2 slide">
				</div>
				</div>
				<!-- / 슬라이드 쇼 끝 -->
				<!-- 왼쪽 오른쪽 화살표 버튼 -->
    ...
    <div class="container-card" style="padding:25px;">
		<div class="row">
			<c:forEach items="${productCategoryMakeUpList}" var="product" varStatus="vs">
				<div class="pcard">
